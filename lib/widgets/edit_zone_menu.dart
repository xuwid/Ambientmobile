...
class _EditZoneMenuState extends State<EditZoneMenu> {
  ...
  void initState() {
    ...
    zoneNameController.addListener(() {
      _onZoneNameChanged(zoneNameController.text);
    });
  }
                      ...
                      Expanded(
                        child: Row(
                          ...
                          children: List.generate(4, (index) {
                            // Print port details here
                            print(
                                'Port ${index + 1}: ${widget.portSelections[index] ? 'Enabled' : 'Disabled'}');
